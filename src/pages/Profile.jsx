          ...
          {couple.couplePhoto ? (
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-0 right-0 p-2 bg-white text-pink-500 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
              >
        ...
        <div className="flex items-center justify-center gap-8">
          <div className="text-center">
            <div className="relative group">
              ...
              <label className="absolute bottom-2 right-0 p-1 bg-white text-pink-500 rounded-full shadow-lg cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity">
