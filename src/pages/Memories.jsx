                ...
                {newMemory.photos.map((photo) => (
                  <div key={photo.id} className="relative w-fit">
                    <img 
                      src={photo.url} 
                      alt={photo.name}
                      className="h-16 w-auto object-contain rounded-lg border border-gray-200 bg-gray-50"
                    />
                    <button
                      type="button"
                            ...
                            {memory.photos.slice(0, expandedMemory === memory.id ? undefined : 4).map((photo) => (
                              <div key={photo.id} className="w-fit">
                                <img
                                  src={photo.url}
                                  alt={photo.name}
                                  className="h-24 w-auto object-contain rounded-lg cursor-pointer hover:opacity-90 transition-opacity border border-gray-200 bg-gray-50"
                                  onClick={(e) => {
                                    e.stopPropagation()
