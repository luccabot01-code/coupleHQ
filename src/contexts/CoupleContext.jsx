  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        // If still no data, this is a new couple
        if (!coupleData) {
        ...
        if (coupleData.settings?.pin && !verified) {
        ...
        if (coupleData.couple?.partner1?.name && coupleData.couple?.partner2?.name) {
