...
export const generateDemoData = () => {
  ...
  return {
    ...
    memories: [
      { id: 1, title: 'First Date ❤️', date: '2022-06-14', description: 'Coffee shop downtown, talked for 4 hours!', mood: 'love', photos: [], tags: ['first', 'date', 'special'] },
      { id: 2, title: 'Proposal Day 💍', date: '2024-06-14', description: 'John proposed at sunset on the beach. She said YES!', mood: 'excited', photos: [], tags: ['proposal', 'engagement', 'milestone'] },
      { id: 3, title: 'First Vacation Together', date: '2023-08-20', description: 'Road trip to the mountains. Amazing views and quality time.', mood: 'happy', photos: [], tags: ['travel', 'vacation', 'adventure'] },
      { id: 4, title: 'Moved In Together 🏠', date: '2023-03-01', description: 'First day in our new apartment. Exciting new chapter!', mood: 'excited', photos: [], tags: ['home', 'milestone', 'together'] },
      { id: 5, title: 'Cooking Disaster 😂', date: '2023-11-15', description: 'Tried to make fancy dinner, ended up ordering pizza. Laughed all night!', mood: 'funny', photos: [], tags: ['funny', 'cooking', 'memories'] },
      { id: 6, title: 'Adopted Our Cat 🐱', date: '2024-02-10', description: 'Meet Whiskers! Our new family member.', mood: 'love', photos: [], tags: ['pet', 'family', 'cat'] },
    ],
