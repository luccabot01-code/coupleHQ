...
export const generateDemoData = () => {
  ...
  return {
    ...
    memories: [
      { id: 1, title: 'First Date ❤️', date: '2022-06-14', description: 'Coffee shop downtown, talked for 4 hours!', mood: 'Heart', photos: [
      ...
      { id: 2, title: 'Proposal Day 💍', date: '2024-06-14', description: 'John proposed at sunset on the beach. She said YES!', mood: 'Sparkles', photos: [
      ...
      { id: 3, title: 'First Vacation Together', date: '2023-08-20', description: 'Road trip to the mountains. Amazing views and quality time.', mood: 'Sun', photos: [
      ...
      { id: 4, title: 'Moved In Together 🏠', date: '2023-03-01', description: 'First day in our new apartment. Exciting new chapter!', mood: 'Home', photos: [
      ...
      { id: 5, title: 'Cooking Disaster 😂', date: '2023-11-15', description: 'Tried to make fancy dinner, ended up ordering pizza. Laughed all night!', mood: 'Smile', photos: [
      ...
      { id: 6, title: 'Adopted Our Cat 🐱', date: '2024-02-10', description: 'Meet Whiskers! Our new family member.', mood: 'Heart', photos: [
